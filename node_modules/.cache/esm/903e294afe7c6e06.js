let ADMISSION_EXAMS,ADMISSION_QUESTIONS,REQUESTS_TO_HIRE_GRADUATE,gen_random_int,admission_exam_email,send_mail,to_title;_fe7‍.x([["update_question",()=>update_question],["get_request_to_hire_graduates",()=>get_request_to_hire_graduates],["admission_questions",()=>admission_questions],["new_question",()=>new_question],["admission_exam",()=>admission_exam],["remove_question",()=>remove_question],["find_admission_exam",()=>find_admission_exam],["request_to_hire_graduate",()=>request_to_hire_graduate],["hire_graduate_resolved",()=>hire_graduate_resolved]]);_fe7‍.w("../ds/conn",[["ADMISSION_EXAMS",["ADMISSION_EXAMS"],function(v){ADMISSION_EXAMS=v}],["ADMISSION_QUESTIONS",["ADMISSION_QUESTIONS"],function(v){ADMISSION_QUESTIONS=v}],["REQUESTS_TO_HIRE_GRADUATE",["REQUESTS_TO_HIRE_GRADUATE"],function(v){REQUESTS_TO_HIRE_GRADUATE=v}]]);_fe7‍.w("../functions",[["gen_random_int",["gen_random_int"],function(v){gen_random_int=v}]]);_fe7‍.w("./emails",[["admission_exam_email",["admission_exam_email"],function(v){admission_exam_email=v}]]);_fe7‍.w("./users",[["send_mail",["send_mail"],function(v){send_mail=v}],["to_title",["to_title"],function(v){to_title=v}]]);
