...
const about_statement = (req, res) => {
  let about_statement = _c5f‍.a("GLOBALS",GLOBALS).readone({ global: GLOBALS_about_statement });
...
const post_about_statement = (req, res) => {
  ...
  let about_statement = _c5f‍.a("GLOBALS",GLOBALS).readone({ global: GLOBALS_about_statement });
  if (about_statement)
    _c5f‍.a("GLOBALS",GLOBALS).update({ global: GLOBALS_about_statement }, { text });
  else _c5f‍.a("GLOBALS",GLOBALS).write({ global: GLOBALS_about_statement, text });
...
const approve_review = (req, res) => {
  ...
  let globals = _c5f‍.a("GLOBALS",GLOBALS).readone({ global: GLOBALS_verified_reviews });
  if (globals)
    _c5f‍.a("GLOBALS",GLOBALS).update(
      { global: GLOBALS_verified_reviews },
      { reviews: { $push: review } }
    );
  else
    _c5f‍.a("GLOBALS",GLOBALS).write({
      global: GLOBALS_verified_reviews,
      review: new Array(review),
    });

  _c5f‍.a("REVIEWS",REVIEWS).update(review, { verified: true });
...
const reviews = (req, res) => {
  ...
  let reviews;
  let verified_reviews = _c5f‍.a("GLOBALS",GLOBALS).readone({
    global: GLOBALS_verified_reviews,
  });
  ...
  reviews = _c5f‍.a("REVIEWS",REVIEWS).read(verified ? reviews : null, {
...
const new_review = (req, res) => {
  ...
  review.image = _c5f‍.a("save_image",save_image)(review.image);

  let result = _c5f‍.a("REVIEWS",REVIEWS).write(review);
  review._id = result._id;
  review.created = result.created;

  if (review.verified)
    if (!!_c5f‍.a("GLOBALS",GLOBALS).readone({ global: GLOBALS_verified_reviews }))
      _c5f‍.a("GLOBALS",GLOBALS).update(
        { global: GLOBALS_verified_reviews },
...
const remove_review = (req, res) => {
  ...
  let review_ = _c5f‍.a("REVIEWS",REVIEWS).readone(review);
  if (!review_) return res.end();

  review_.image && !review_.user && _c5f‍.a("remove_image",remove_image)(review_.image);
  review_.verified &&
    _c5f‍.a("GLOBALS",GLOBALS).update(
      { global: GLOBALS_verified_reviews },
  ...
  _c5f‍.a("REVIEWS",REVIEWS).remove(review);
...
const trusted_by = (req, res) => {
  res.json({
    ...
    data: _c5f‍.a("TRUSTEES",TRUSTEES).read(),
  });
};
...
const add_trusted_by = (req, res) => {
  ...
  trustee.logo = _c5f‍.a("save_image",save_image)(trustee.logo);
  let result = _c5f‍.a("TRUSTEES",TRUSTEES).write(trustee);
...
const remove_trustee = (req, res) => {
  ...
  trustee = _c5f‍.a("TRUSTEES",TRUSTEES).remove(trustee);
  trustee && _c5f‍.a("remove_image",remove_image)(trustee.logo);
...
const alumni_overview = (req, res) => {
  let alumni_overview_ = _c5f‍.a("GLOBALS",GLOBALS).readone({ global: GLOBAL_alumni_overview });
...
const update_alumni_overview = (req, res) => {
  ...
  (video = _c5f‍.a("save_video",save_video)(video)), (thumbnail = _c5f‍.a("save_image",save_image)(thumbnail));

  let alumni_overview = _c5f‍.a("GLOBALS",GLOBALS).readone({ global: GLOBAL_alumni_overview });
  alumni_overview &&
    (thumbnail.startsWith("data") && _c5f‍.a("remove_image",remove_image)(alumni_overview.thumbnail),
    video.startsWith("data") && _c5f‍.a("remove_video",remove_video)(alumni_overview.video));
...
const banner_stuffs = (req, res) => {
  let banner_stuffs_ = _c5f‍.a("GLOBALS",GLOBALS).readone({ global: GLOBAL_banner_stuffs });

  res.json({ ok: true, message: "banner stuffs", data: banner_stuffs_ });
};

const onboarding_stuffs = (req, res) => {
  let onboarding_stuffs_ = _c5f‍.a("GLOBALS",GLOBALS).readone({
...
const handle_onboarding_stuffs = (req, res) => {
  ...
  let prior = _c5f‍.a("GLOBALS",GLOBALS).readone({ global: GLOBAL_onboarding_stuffs });
  if (!!prior) {
    if (prior.image && image && image.startsWith("data"))
      _c5f‍.a("remove_image",remove_image)(prior.image);
    if (prior.video && video && video.startsWith("data"))
      _c5f‍.a("remove_video",remove_video)(prior.video);

    image = _c5f‍.a("save_image",save_image)(image);
    video = _c5f‍.a("save_image",save_image)(video);
    ...
    _c5f‍.a("GLOBALS",GLOBALS).write({
      ...
      image_hash,
      steps,
      video: _c5f‍.a("save_video",save_video)(video),
      global: GLOBAL_onboarding_stuffs,
    });
...
const best_instructors_stuffs = (req, res) => {
  let best_instructor_stuffs_ = _c5f‍.a("GLOBALS",GLOBALS).readone({
...
const handle_best_instructors_stuffs = (req, res) => {
  ...
  let prior = _c5f‍.a("GLOBALS",GLOBALS).readone({ global: GLOBAL_best_instructor_stuffs });
  if (!!prior) {
    if (prior.image && image && image.startsWith("data"))
      _c5f‍.a("remove_image",remove_image)(prior.image);
    if (prior.video && video && video.startsWith("data"))
...
const faqs = (req, res) => {
  ...
  let faqs_ = _c5f‍.a("FAQS",FAQS).read(null, { limit, skip });
  if (total_faqs)
    faqs_ = { faqs: faqs_, total_faqs: _c5f‍.a("FAQS",FAQS).config.total_entries };

  res.json({ ok: true, message: "faqs", data: faqs_ });
};

const new_faq = (req, res) => {
  let result = _c5f‍.a("FAQS",FAQS).write(req.body);
...
const update_faq = (req, res) => {
  ...
  let result = _c5f‍.a("FAQS",FAQS).update(_id, { question, answer });
